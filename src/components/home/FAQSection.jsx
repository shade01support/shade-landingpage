...
const FAQSection = () => {
  ...
  return (
    <section id="faq" className="py-20 bg-gradient-to-b from-white via-white to-primary/10 scroll-mt-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-700 font-metropolis">
